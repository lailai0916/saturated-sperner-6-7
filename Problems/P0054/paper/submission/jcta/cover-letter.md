...
Please consider the manuscript “The exact saturated 6- and 7-Sperner
numbers” for publication as a research article in the _Journal of
Combinatorial Theory, Series A_.

The manuscript determines two eventual extremal values for saturated
Sperner systems. It proves that the eventual saturated 6-Sperner number is
30 and that the eventual saturated 7-Sperner number is 55. The lower bounds
combine canonical-layer reductions with blocker inequalities on arbitrary
finite ground sets. The seven-layer proof further resolves a finite list of
equality profiles through exact branch arguments and independently checkable
certificate reductions. An explicit 55-member construction gives the
matching upper bound and improves the associated composition split from
28/28 to 28/27.

A separately submitted supplement records the
...
submission cites GitHub release `v1.1.2` and Zenodo DOI
`10.5281/zenodo.21770438`, which contain this exact revision.
...
No. 76 Dongxin Avenue, Binjiang District  
Hangzhou, Zhejiang 310053, China  
lailai0x394@gmail.com  
ORCID: 0009-0008-9790-9881
