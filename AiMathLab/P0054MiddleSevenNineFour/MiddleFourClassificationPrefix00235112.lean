import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351121
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351122
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351123
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351124
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351125
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351126
...
theorem middle_four_classification_prefix_00235_1_1_2 :
  ...
  · have h := middle_four_classification_prefix_00235_1_1_2_5
    ...
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_2_6
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
