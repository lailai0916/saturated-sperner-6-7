import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911341
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911342
...
theorem middle_four_classification_prefix_00219_1_1_3_4 :
    middleFourClassificationValuesCheck 219 [1, 1, 3, 4] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_1_1_3_4_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_1_1_3_4_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
