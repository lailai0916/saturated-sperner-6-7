import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix016751211
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix016751212
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix016751213
...
theorem middle_four_classification_prefix_01675_1_2_1 :
    middleFourClassificationValuesCheck 1675 [1, 2, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_01675_1_2_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_01675_1_2_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_01675_1_2_1_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
