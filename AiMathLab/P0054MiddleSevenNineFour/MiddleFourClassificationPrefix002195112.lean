import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021951121
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021951122
...
theorem middle_four_classification_prefix_00219_5_1_1_2 :
    middleFourClassificationValuesCheck 219 [5, 1, 1, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_5_1_1_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_5_1_1_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
