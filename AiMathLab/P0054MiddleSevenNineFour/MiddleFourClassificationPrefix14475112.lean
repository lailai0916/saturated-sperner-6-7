import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix144751121
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix144751122
...
theorem middle_four_classification_prefix_14475_1_1_2 :
    middleFourClassificationValuesCheck 14475 [1, 1, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_14475_1_1_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_14475_1_1_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
