import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911521
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911522
...
theorem middle_four_classification_prefix_00219_1_1_5_2 :
    middleFourClassificationValuesCheck 219 [1, 1, 5, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_1_1_5_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_1_1_5_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
