import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911251
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911252
...
theorem middle_four_classification_prefix_00219_1_1_2_5 :
    middleFourClassificationValuesCheck 219 [1, 1, 2, 5] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_1_1_2_5_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_1_1_2_5_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
