import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix00235121
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix00235122
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix00235123
...
theorem middle_four_classification_prefix_00235_1_2 :
    middleFourClassificationValuesCheck 235 [1, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_1_2_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
