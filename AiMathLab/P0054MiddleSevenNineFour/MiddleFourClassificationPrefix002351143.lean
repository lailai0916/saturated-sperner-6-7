import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511431
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511432
...
theorem middle_four_classification_prefix_00235_1_1_4_3 :
    middleFourClassificationValuesCheck 235 [1, 1, 4, 3] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_1_4_3_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_4_3_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
