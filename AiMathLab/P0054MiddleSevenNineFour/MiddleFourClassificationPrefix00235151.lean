import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351511
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351512
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351513
...
theorem middle_four_classification_prefix_00235_1_5_1 :
    middleFourClassificationValuesCheck 235 [1, 5, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_5_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_5_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_1_5_1_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
