import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511241
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511242
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511243
...
theorem middle_four_classification_prefix_00235_1_1_2_4 :
    middleFourClassificationValuesCheck 235 [1, 1, 2, 4] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_1_2_4_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_2_4_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_2_4_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
