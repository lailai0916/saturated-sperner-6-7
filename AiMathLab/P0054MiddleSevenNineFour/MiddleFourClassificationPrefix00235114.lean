import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351141
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351142
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351143
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002351144
...
theorem middle_four_classification_prefix_00235_1_1_4 :
  ...
  · have h := middle_four_classification_prefix_00235_1_1_4_3
    ...
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_4_4
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
