import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511151
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511152
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511153
...
theorem middle_four_classification_prefix_00235_1_1_1_5 :
    middleFourClassificationValuesCheck 235 [1, 1, 1, 5] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_1_1_5_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_1_5_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_1_5_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
