import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511611
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511612
...
theorem middle_four_classification_prefix_00235_1_1_6_1 :
    middleFourClassificationValuesCheck 235 [1, 1, 6, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_1_6_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_6_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
