import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix08363131
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix08363132
...
theorem middle_four_classification_prefix_08363_1_3 :
    middleFourClassificationValuesCheck 8363 [1, 3] = true := by
  ...
  · have h := middle_four_classification_prefix_08363_1_3_1
    ...
    exact h
  · have h := middle_four_classification_prefix_08363_1_3_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
