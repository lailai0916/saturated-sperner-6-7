import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002352211
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002352212
...
theorem middle_four_classification_prefix_00235_2_2_1 :
    middleFourClassificationValuesCheck 235 [2, 2, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_2_2_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_2_2_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
