import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911511
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911512
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911513
...
theorem middle_four_classification_prefix_00219_1_1_5_1 :
    middleFourClassificationValuesCheck 219 [1, 1, 5, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_1_1_5_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_1_1_5_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00219_1_1_5_1_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
