import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023513141
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023513142
...
theorem middle_four_classification_prefix_00235_1_3_1_4 :
    middleFourClassificationValuesCheck 235 [1, 3, 1, 4] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_3_1_4_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_3_1_4_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
