import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921221
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921222
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921223
...
theorem middle_four_classification_prefix_00219_2_1_2_2 :
    middleFourClassificationValuesCheck 219 [2, 1, 2, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_2_1_2_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_2_1_2_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00219_2_1_2_2_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
