import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002431211
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002431212
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002431213
...
theorem middle_four_classification_prefix_00243_1_2_1 :
    middleFourClassificationValuesCheck 243 [1, 2, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00243_1_2_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00243_1_2_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00243_1_2_1_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
