import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002191221
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002191222
...
theorem middle_four_classification_prefix_00219_1_2_2 :
    middleFourClassificationValuesCheck 219 [1, 2, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_1_2_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_1_2_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
