import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921141
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921142
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921143
...
theorem middle_four_classification_prefix_00219_2_1_1_4 :
    middleFourClassificationValuesCheck 219 [2, 1, 1, 4] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_2_1_1_4_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_2_1_1_4_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00219_2_1_1_4_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
