import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix00818111
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix00818112
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix00818113
...
theorem middle_four_classification_prefix_00818_1_1 :
    middleFourClassificationValuesCheck 818 [1, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00818_1_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00818_1_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00818_1_1_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
