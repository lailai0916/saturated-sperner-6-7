import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911431
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021911432
...
theorem middle_four_classification_prefix_00219_1_1_4_3 :
    middleFourClassificationValuesCheck 219 [1, 1, 4, 3] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_1_1_4_3_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_1_1_4_3_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
