import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002195111
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002195112
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix002195113
...
theorem middle_four_classification_prefix_00219_5_1_1 :
    middleFourClassificationValuesCheck 219 [5, 1, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_5_1_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_5_1_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00219_5_1_1_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
