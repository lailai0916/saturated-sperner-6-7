import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023513131
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023513132
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023513133
...
theorem middle_four_classification_prefix_00235_1_3_1_3 :
    middleFourClassificationValuesCheck 235 [1, 3, 1, 3] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_3_1_3_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_3_1_3_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_1_3_1_3_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
