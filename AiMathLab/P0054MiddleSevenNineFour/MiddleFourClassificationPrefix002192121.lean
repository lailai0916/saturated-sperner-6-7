import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921211
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921212
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921213
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021921214
...
theorem middle_four_classification_prefix_00219_2_1_2_1 :
  ...
  · have h := middle_four_classification_prefix_00219_2_1_2_1_3
    ...
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00219_2_1_2_1_4
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
