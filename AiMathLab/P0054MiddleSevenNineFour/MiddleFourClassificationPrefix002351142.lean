import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511421
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511422
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023511423
...
theorem middle_four_classification_prefix_00235_1_1_4_2 :
    middleFourClassificationValuesCheck 235 [1, 1, 4, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_1_1_4_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_4_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_1_1_4_2_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
