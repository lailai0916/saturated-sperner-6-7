import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021922111
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021922112
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0021922113
...
theorem middle_four_classification_prefix_00219_2_2_1_1 :
    middleFourClassificationValuesCheck 219 [2, 2, 1, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00219_2_2_1_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00219_2_2_1_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00219_2_2_1_1_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
