import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix00459211
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix00459212
...
theorem middle_four_classification_prefix_00459_2_1 :
    middleFourClassificationValuesCheck 459 [2, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00459_2_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00459_2_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
