import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023521121
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023521122
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix0023521123
...
theorem middle_four_classification_prefix_00235_2_1_1_2 :
    middleFourClassificationValuesCheck 235 [2, 1, 1, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_00235_2_1_1_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00235_2_1_1_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00235_2_1_1_2_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
