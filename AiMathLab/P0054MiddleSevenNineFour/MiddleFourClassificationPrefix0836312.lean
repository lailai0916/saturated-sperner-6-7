import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix08363121
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix08363122
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix08363123
...
theorem middle_four_classification_prefix_08363_1_2 :
    middleFourClassificationValuesCheck 8363 [1, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_08363_1_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_08363_1_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_08363_1_2_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
