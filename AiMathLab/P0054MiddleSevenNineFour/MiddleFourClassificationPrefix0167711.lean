import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix01677111
import AiMathLab.P0054MiddleSevenNineFour.MiddleFourClassificationPrefix01677112
...
theorem middle_four_classification_prefix_01677_1_1 :
    middleFourClassificationValuesCheck 1677 [1, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_01677_1_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_01677_1_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
