import AiMathLab.P0054G420.MiddleFourClassificationPrefix00243211
import AiMathLab.P0054G420.MiddleFourClassificationPrefix00243212
...
theorem middle_four_classification_prefix_00243_2_1 :
    middleFourClassificationValuesCheck 243 [2, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00243_2_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00243_2_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
