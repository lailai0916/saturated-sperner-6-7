...
def threePaddedModelBlockerRows00 :
...
theorem three_padded_model_blocker_rows_00 :
    middleFourModelBlockerRows
        [1, 0, 0, 1, 0, 1, 0, 1, 0, 2, 0, 0, 0, 0] =
      threePaddedModelBlockerRows00 := by
  decide

theorem three_padded_model_property_00 :
    ThreePaddedModelProperty
      [1, 0, 0, 1, 0, 1, 0, 1, 0, 2, 0, 0, 0, 0] := by
  unfold ThreePaddedModelProperty middleFourModelBlocker
  rw [three_padded_model_blocker_rows_00]
  constructor
  · decide
  · intro P hP
    simp [threePaddedModelBlockerRows00] at hP
