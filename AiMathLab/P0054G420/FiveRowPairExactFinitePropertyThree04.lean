...
def threePaddedModelBlockerRows04 :
    List (G413.Row MiddleFourModelPoint) :=
  [{0, 3, 5}, {0, 3, 4}, {0, 2, 5}, {0, 2, 4}, {0, 1, 5}]

set_option maxHeartbeats 10000000 in
-- The explicit blocker-list reduction traverses the finite active-point powerset.
set_option maxRecDepth 1000000 in
theorem three_padded_model_blocker_rows_04 :
    middleFourModelBlockerRows
        [1, 1, 0, 0, 0, 2, 0, 1, 0, 0, 0, 1, 0, 0] =
      threePaddedModelBlockerRows04 := by
  decide

theorem three_padded_model_property_04 :
    ThreePaddedModelProperty
      [1, 1, 0, 0, 0, 2, 0, 1, 0, 0, 0, 1, 0, 0] := by
  unfold ThreePaddedModelProperty middleFourModelBlocker
  rw [three_padded_model_blocker_rows_04]
  constructor
  · decide
  · intro P hP
    simp [threePaddedModelBlockerRows04] at hP
