...
theorem four_exceptional_pair_exact_block_133 (offset : Fin 64) :
    smallFourClassificationMaskCheck 3
      fourExceptionalMultiplicityLeafValid
      fourExceptionalMultiplicityInCertificate (8512 + offset.val) = true := by
  fin_cases offset
  · rfl
  · rfl
  · rfl
  ...
  · exact (List.all_eq_true.mp
      four_exceptional_pair_exact_mask_group_059) 8522 (by decide)
  · rfl
  · rfl
  · rfl
  · rfl
...
theorem three_padded_pair_exact_block_133 (offset : Fin 64) :
    smallFourClassificationMaskCheck 0
      threePaddedMultiplicityLeafValid
      threePaddedMultiplicityInCertificate (8512 + offset.val) = true := by
  fin_cases offset
  · rfl
  · rfl
  · rfl
