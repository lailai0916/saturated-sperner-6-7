...
theorem four_exceptional_pair_exact_block_019 (offset : Fin 64) :
    smallFourClassificationMaskCheck 3
      fourExceptionalMultiplicityLeafValid
      fourExceptionalMultiplicityInCertificate (1216 + offset.val) = true := by
  fin_cases offset
  · rfl
  · rfl
  · rfl
  ...
  · exact (List.all_eq_true.mp
      four_exceptional_pair_exact_mask_group_023) 1227 (by decide)
  · rfl
  · rfl
  · rfl
  · exact (List.all_eq_true.mp
      four_exceptional_pair_exact_mask_group_023) 1231 (by decide)
  · rfl
  · rfl
  · rfl
  · rfl
...
theorem three_padded_pair_exact_block_019 (offset : Fin 64) :
    smallFourClassificationMaskCheck 0
      threePaddedMultiplicityLeafValid
      threePaddedMultiplicityInCertificate (1216 + offset.val) = true := by
  fin_cases offset
  · rfl
  · rfl
  · rfl
