import AiMathLab.P0054G420.MiddleFourClassificationPrefixes01231
...
theorem middle_four_classification_mask_01231 :
  ...
  · exact middleFourClassificationValuesCheck_of_list
      middle_four_classification_prefixes_01231 (by decide)
  · have hFalse :
      middleFourTwoPrefixAdmissible 1231 1 5 = false := by rfl
  ...
  · have hFalse :
    ...
    contradiction
  · have hFalse :
      middleFourTwoPrefixAdmissible 1231 5 1 = false := by rfl
    rw [hFalse] at hAdmissible
    contradiction
  · have hFalse :
