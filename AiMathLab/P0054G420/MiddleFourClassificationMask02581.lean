import AiMathLab.P0054G420.MiddleFourClassificationPrefixes02581
...
theorem middle_four_classification_mask_02581 :
  ...
  · exact middleFourClassificationValuesCheck_of_list
      middle_four_classification_prefixes_02581 (by decide)
  · have hFalse :
      middleFourTwoPrefixAdmissible 2581 5 3 = false := by rfl
    rw [hFalse] at hAdmissible
    contradiction
  · have hFalse :
  ...
  · exact middleFourClassificationValuesCheck_of_list
      middle_four_classification_prefixes_02581 (by decide)
  · have hFalse :
      middleFourTwoPrefixAdmissible 2581 6 2 = false := by rfl
    rw [hFalse] at hAdmissible
    contradiction
  · have hFalse :
  ...
  · have hFalse :
    ...
    contradiction
  · have hFalse :
      middleFourTwoPrefixAdmissible 2581 7 1 = false := by rfl
    rw [hFalse] at hAdmissible
    contradiction
  · have hFalse :
