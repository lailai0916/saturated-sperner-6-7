import AiMathLab.P0054G420.MiddleFourClassificationPrefixes06283
...
theorem middle_four_classification_mask_06283 :
  ...
  · exact middleFourClassificationValuesCheck_of_list
      middle_four_classification_prefixes_06283 (by decide)
  · have hFalse :
      middleFourTwoPrefixAdmissible 6283 1 3 = false := by rfl
  ...
  · have hFalse :
    ...
    contradiction
  · have hFalse :
      middleFourTwoPrefixAdmissible 6283 4 1 = false := by rfl
    rw [hFalse] at hAdmissible
    contradiction
  · have hFalse :
