import AiMathLab.P0054G420.MiddleFourClassificationPrefix00222311
import AiMathLab.P0054G420.MiddleFourClassificationPrefix00222312
import AiMathLab.P0054G420.MiddleFourClassificationPrefix00222313
...
theorem middle_four_classification_prefix_00222_3_1 :
    middleFourClassificationValuesCheck 222 [3, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00222_3_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00222_3_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
    exact h
  · have h := middle_four_classification_prefix_00222_3_1_3
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
