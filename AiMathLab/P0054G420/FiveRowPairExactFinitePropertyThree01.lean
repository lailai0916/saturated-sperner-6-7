...
def threePaddedModelBlockerRows01 :
...
theorem three_padded_model_blocker_rows_01 :
    middleFourModelBlockerRows
        [1, 0, 0, 1, 0, 2, 0, 1, 0, 1, 0, 0, 0, 0] =
      threePaddedModelBlockerRows01 := by
  decide

theorem three_padded_model_property_01 :
    ThreePaddedModelProperty
      [1, 0, 0, 1, 0, 2, 0, 1, 0, 1, 0, 0, 0, 0] := by
  unfold ThreePaddedModelProperty middleFourModelBlocker
  rw [three_padded_model_blocker_rows_01]
  constructor
  · decide
  · intro P hP
    simp [threePaddedModelBlockerRows01] at hP
