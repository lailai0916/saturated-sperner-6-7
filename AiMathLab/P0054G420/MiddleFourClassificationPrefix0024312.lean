import AiMathLab.P0054G420.MiddleFourClassificationPrefix00243121
import AiMathLab.P0054G420.MiddleFourClassificationPrefix00243122
...
theorem middle_four_classification_prefix_00243_1_2 :
    middleFourClassificationValuesCheck 243 [1, 2] = true := by
  ...
  · have h := middle_four_classification_prefix_00243_1_2_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00243_1_2_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
