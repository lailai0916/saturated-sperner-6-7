import AiMathLab.P0054G420.MiddleFourClassificationPrefix002071211
import AiMathLab.P0054G420.MiddleFourClassificationPrefix002071212
...
theorem middle_four_classification_prefix_00207_1_2_1 :
    middleFourClassificationValuesCheck 207 [1, 2, 1] = true := by
  ...
  · have h := middle_four_classification_prefix_00207_1_2_1_1
    ...
    exact h
  · have h := middle_four_classification_prefix_00207_1_2_1_2
    unfold middleFourClassificationValuesCheck at h
    rw [hSupports] at h
    simp only [middleFourClassificationValuesCheckAux] at h
    rw [if_pos (by decide), if_pos (by decide), if_pos (by decide), if_pos (by decide)] at h
